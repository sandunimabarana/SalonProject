...
<%@page import="yala.UserDAOImplement.ResourcesDaoImplement"%>
<%@page import="yala.DAO.ResourcesDao"%>
<%@page import="yala.pojo.Resources"%>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="ShowReservations.jsp">Bridal Booking</a></li>
                    
                    <%}else if (request.getSession().getAttribute("type").equals("user")) {%>
                    <li><a href="WeddingBooking.jsp"  class="active">Bridal Booking</a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <div class="details"><div class="data">
                        ...
                        <h3><br>Wedding Facilities providing by Akeera salon </h3>         
                        <p>
                           Wedding dreams come alive at Wedding Salon Luxury Showcases with lavish florals, live wedding entertainment, elegantly decorated reception tables, stunning fashion previews, decadent table décor, and wedding sweets for sampling. No matter what your wedding fantasies include— a traditional storybook wedding, an intimate island getaway— or anything in between, the Wedding Salon is your ultimate bridal resource.  Guests will have the opportunity to meet with the best in weddings, including Photographers, Videographers, Wedding Entertainers, Beauty Experts, Bakeries, Invitation and Favor Creators, Celebrity Wedding Planners, Venues, Travel & Honeymoon Experts, Health & Fitness Gurus and more.  
                        </p>
                    ...
                    <form action="ReservationController" method="GET">
                        ...
                        <p>
                            ...
                            <select name="type">
                                ...
                                List<Resources> list = resourceDaoImpl.showAllBridal();
                                
                                    for (int i = 0; i < list.size(); i++) {
                                        Resources resource = new Resources();
                                        resource = list.get(i);
                                %>
                                <option value="<%out.print(resource.getReso_No());%>"><%out.print(resource.getDescription());%></option>
