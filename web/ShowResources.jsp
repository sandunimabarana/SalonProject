         ...
         <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="ShowResources.jsp"  class="active">Show Facilities</a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="details"><div class="data">
                        ...
                        <h3><br>Facilities providing by Akeera Beauty Salon </h3>         
                        <ul>
                        ...
                        <h3>Beauty Facility for child</h3>        
                        <ul>
                            <li>Hair Cutting</li>
                ...
                <div id="reg"  class="reg">
                    ...
                    <table class="table">
                        ...
                        <%
                            ...
                            List<Resources> list = resourceDaoImpl.showAllResources();
                        ...
                        <tr>
                            <td><%out.print(resource.getReso_No());%></td>
                            <td><%out.print(resource.getDescription());%></td>
                            <td><%out.print(resource.getAuthPerson());%></td>
                            <td><%out.print(resource.getType());%></td>
                            <td><%out.print(resource.getMaxCount());%></td>
                            <td><%out.print(resource.getCharges());%></td>
                            
                            <% if (request.getSession().getAttribute("type").equals("admin")) { %>
                            <td><form action="ResourceController" method="POST">
                                    <input type="hidden" name="reso_No" id = "reso_No" value="<%out.print(resource.getReso_No());%>">
                                    <input class="button" type="submit" name="deleteResource" value="Delete">
                                </form></td>
                                <% }%>
