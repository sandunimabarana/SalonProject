      ...
      <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="HairCuttingBooking.jsp"  class="active">Hair Cutting</a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <div class="details"><div class="data">
                        ...
                        <p>A French word meaning to sweep or paint. A colorist will area-paint highlights onto the hair in a sweeping motion. This gives a much more natural, sun-kissed look, as opposed to streaky, top-to-bottom highlights. With balayage, regrowth lines are less noticeable, so the color still looks great long after your appointment. (Don’t miss the myths about hair you need to stop believing.)</p>
                    ...
                    <form action="ReservationController" method="GET">
                        ...
                        <p>
                            ...
                            <select name="type">
                                ...
                                List<Resources> list = resourceDaoImpl.showAllHairCutting();
